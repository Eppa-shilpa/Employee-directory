...
const jsonObj=JSON.stringify(myArray);
console.log(jsonObj);
...
const imgRef=document.getElementById('File1');
imgRef.onchange=function LoadImage(e)
{           
    window.pat=e.target.value;
    console.log(window.pat);      
//  window.path=document.getElementById('File1').value;      
